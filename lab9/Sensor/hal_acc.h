 ...
 *
 * -- $Revision: 1607 $
 * -- $Id: hal_acc.h 1607 2018-10-11 13:42:52Z angv $
 * --------------------------------------------------------------- */
 ...
 *                                   - MISO:  PA6
 *                                   - MOSI:  PA7
 *                    DMA         Init DMA to read Acceleration trough
 *
...
/**
 * \brief Read/Write data via SPI1 on Port P5 using with DMA,
